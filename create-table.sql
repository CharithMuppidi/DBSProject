...
CREATE TABLE PERSON(
    PID CHAR(4) NOT NULL PRIMARY KEY,  -- PK
...
CREATE TABLE MEMBER(
	CID CHAR(4) NOT NULL PRIMARY KEY,		-- CID for Card ID with be MEMBER's primary key
...
CREATE TABLE BORROW(
    ...
    borrow_date DATE,
    return_date DATE,
    PID CHAR(4) NOT NULL,     -- person id
    EID CHAR(4) NOT NULL,     -- employee id
...
CREATE TABLE GUEST_LOG(
    CID CHAR(4) NOT NULL,
    GID CHAR(4) NOT NULL,
    guest_address VARCHAR(70),
    guest_name VARCHAR(41) NOT NULL,
    contact_info CHAR(12),
